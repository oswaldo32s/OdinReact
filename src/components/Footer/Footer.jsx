    ...
    <div className={styles.wrapContainer}>
      <footer className={styles.container}>
        <article>
          ...
          <p className={styles.text}>Let me know your questions. Let&apos;s Talk!</p>
        </article>
        <div className={styles.buttonContainer}>
          <button className={styles.button}>
          <a href="https://www.instagram.com/oswaldo32g/" target='_blank'>
          ...
          <button className={styles.button}>
          <a href="https://www.facebook.com/oswaldo32s" target='_blank'>
          ...
          <button className={styles.button}>
            <a href="https://www.linkedin.com/in/oswaldojgg/" target='_blank'>
